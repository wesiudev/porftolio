  ...
  return (
    <div className="w-max text-left flex flex-col bg-white rounded-xl p-6 m-6">
      <button className="flex flex-row items-center p-3 group">
        <div className="h-max w-max bg-blue-400 p-1 mr-2 rounded-lg text-white duration-200 ease-in group-hover:bg-blue-300 group-hover:drop-shadow-lg shadow-black">
