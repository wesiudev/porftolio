  ...
  return (
    <div className="flex flex-row justify-between  w-full p-6 rounded-b-xl bg-white">
      ...
      >
        ...
        >
          <span className="text-xl ml-2 font-bold">{user?.email}</span>{" "}
        ...
        >
          <div className="flex flex-col">
            <div className="flex flex-row items-center w-full cursor-pointer p-2 duration-300 hover:bg-blue-100 bg-blue-200 rounded-lg">
              <AiFillCaretRight className="mr-2 h-6 w-6" />
              <span className="text-xl">{userData.websiteName}</span>
            </div>
            <button
              className="mt-3 pb-1 w-full text-gray-400 flex flex-row items-center justify-center text-xl"
              onClick={logout}
            >
