  ...
  return (
    ...
    <>
      ...
      <main className="h-full flex flex-col justify-between relative w-full px-3 lg:px-0 lg:w-3/4 mx-auto min-h-screen bg-red-500">
        ...
        <div className="absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] h-max sm:w-max duration-200 z-50 flex justify-center items-center text-center sm:text-left text-lg sm:text-2xl lg:text-3xl">
          <TextSwitcher dictionary={dictionary["TextSwitcher"]} />
        </div>
        <div className="fixed left-0 top-0 background-image h-full w-full"></div>
        <div className="fixed left-0 top-0 bg-gradient-to-br from-gray-500 via-gray-300 to-gray-500 background-animate delay-1000 h-full w-screen"></div>
        <HomeTitle />
      </main>
      <div className="mt-12">
