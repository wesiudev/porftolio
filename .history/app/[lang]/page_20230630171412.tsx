  ...
  return (
    ...
    <>
      ...
      <main className="h-full flex flex-col justify-between relative w-full px-3 lg:px-0 lg:w-3/4 mx-auto min-h-screen bg-red-500">
        <div className="fixed left-0 top-0 bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 bg-opacity-80 background-image delay-1000 h-full w-full"></div>
        <div className="fixed left-0 top-0 bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 bg-opacity-80 background-animate delay-1000 h-full w-full"></div>
        <div className="h-max w-max mx-auto my-auto flex flex-col select-none">
          <HomeTitle />
        </div>
      </main>
      <div className="mt-12">
