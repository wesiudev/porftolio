      ...
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-x-hidden">
        ...
        <div className="h-screen flex flex-col items-center justify-center w-full lg:w-3/4 lg:flex-row lg:mx-auto lg:mt-0 ">
          <div className="w-full bg-transparent h-max mx-auto lg:mx-0 ">
            ...
            <ScrollButton to="1">
              <span className="text-xl mx-auto h-max lg:text-2xl text-white items-center p-3 hover:to-gray-400 rounded-md bg-green-500 hover:bg-green-400 w-max mt-8 lg:mx-0">
