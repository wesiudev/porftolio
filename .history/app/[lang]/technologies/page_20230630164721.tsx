    ...
    <>
      ...
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-x-hidden">
        ...
        <div className="h-screen flex flex-col items-center justify-center w-full lg:w-3/4 lg:flex-row lg:mx-auto lg:mt-0 ">
          ...
          <div className="h-[90vh] w-1/2 items-center justify-center skew-x-12 lg:flex hidden relative">
            <div className="absolute h-[45vh] w-2 bg-slate-200 -left-12 skew-x-12 top-[50%] -translate-y-[50%]" />
            <Image
              unoptimized
              src="https://firebasestorage.googleapis.com/v0/b/decocanva-408fb.appspot.com/o/image-556239?alt=media&token=01e2ea65-c473-4808-a935-dbb03e81c7ab"
              alt="Technologies Hero Image"
