        ...
        <div className="h-max flex flex-col items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-12">
          <div className="w-full mx-auto lg:mx-0 bg-gradient-to-r py-6">
            ...
            <Image
              ...
              width={1024}
              height={1024}
              className="w-4/5  group-hover:-translate-y-3 group-hover:scale-105 duration-100 py-6 mx-auto lg:hidden"
            />
          ...
          <div className="h-[90vh] w-1/2 overflow-hidden flex items-center justify-center skew-x-12  lg:block hidden">
            <Image
              unoptimized
              src="https://firebasestorage.googleapis.com/v0/b/decocanva-408fb.appspot.com/o/image-556239?alt=media&token=01e2ea65-c473-4808-a935-dbb03e81c7ab"
              alt="Technologies Hero Image"
