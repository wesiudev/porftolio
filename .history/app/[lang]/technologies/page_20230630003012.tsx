  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-400 min-h-screen flex flex-col pb-24 relative">
        ...
        <div className="h-max flex items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto bg-red-500 mt-12">
          <div className="w-full bg-gradient-to-r py-6">
            ...
            <Image
              ...
              width={256}
              height={256}
              className="w-1/3 group-hover:-translate-y-3 group-hover:scale-105 duration-100 py-6 mx-auto lg:hidden"
            />
          ...
          <Image
            ...
            width={256}
            height={256}
            className="w-1/3 group-hover:-translate-y-3 group-hover:scale-105 duration-100 py-6 mx-auto"
          />
        </div>
