      ...
      <div className="w-full bg-gray-400 min-h-screen flex flex-col pb-24 relative overflow-x-hidden">
        ...
        <div className="h-max  flex flex-col items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-24 lg:mt-0">
          <div className="w-full h-max mx-auto lg:mx-0 bg-gradient-to-r ">
            ...
            <h2 className="w-4/5 sm:w-3/5 lg:w-full lg:pr-3 text-center lg:text-left mx-auto lg:mx-0 text-xl sm:text-2xl  lg:pt-12 drop-shadow-lg shadow-black text-white">
