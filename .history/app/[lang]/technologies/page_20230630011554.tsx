  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col pb-24 relative overflow-x-hidden">
        ...
        <div className="h-max lg:h-[90vh] skew-x-12  flex flex-col items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-24 lg:mt-[5vh]">
          <div className="w-full h-max lg:h-full lg:my-auto mx-auto lg:mx-0 bg-gradient-to-r lg:flex lg:justify-center lg:items-center lg:flex-col">
            <h1 className="text-center lg:text-left w-full px-3 pb-6 lg:px-0 sm:w-3/4 mx-auto lg:mx-0 text-5xl sm:text-6xl xl:text-7xl drop-shadow-lg shadow-black text-white font-bold">
          ...
          <div className="h-[90vh] w-1/2 overflow-hidden items-center justify-center skew-x-12 lg:flex hidden bg-red-500">
            <Image
              unoptimized
              src="https://firebasestorage.googleapis.com/v0/b/decocanva-408fb.appspot.com/o/image-556239?alt=media&token=01e2ea65-c473-4808-a935-dbb03e81c7ab"
              alt="Technologies Hero Image"
