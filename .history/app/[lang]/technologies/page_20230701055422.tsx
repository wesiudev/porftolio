  ...
  return (
    <>
      ...
      <div
        className={`${
          isVisible
            ? "sm:rounded-t-[0] lg:rounded-t-[0]"
            : "sm:rounded-t-[125px] lg:rounded-t-[250px]"
        } sm:rounded-b-[125px] lg:rounded-b-[250px] duration-300 w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-hidden pb-24`}
      >
        <div
