...
export default async function technologies({
  ...
  return (
    <>
      ...
      />
      <div className="w-full bg-gray-400 min-h-screen flex flex-col pb-24 relative overflow-x-hidden">
        <FurtherHeader location="technologies" />
        <div className="h-max flex flex-col items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-12">
          <div className="w-full mx-auto lg:mx-0 bg-gradient-to-r py-6">
            ...
            <div className="h-1 bg-slate-600 w-24 mx-auto mt-6 lg:hidden rounded-full"></div>
            <div className="h-[50vh] w-full overflow-hidden flex items-center justify-center lg:hidden my-12">
              <Image
                unoptimized
            ...
            <div className="h-1 bg-slate-600 w-24 mx-auto my-6 lg:hidden rounded-full"></div>
            <h2 className="w-4/5 sm:w-3/5 lg:w-full lg:pr-3 text-center lg:text-left mx-auto lg:mx-0 text-xl sm:text-2xl lg:text-4xl lg:pt-12 drop-shadow-lg shadow-black text-white">
