  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-x-hidden">
        ...
        <div className="h-screen flex flex-col items-center justify-center w-full lg:w-3/4 lg:flex-row lg:mx-auto lg:mt-0 drop-shadow-xl shadow-black">
          <div className="w-full bg-transparent h-max mx-auto lg:mx-0 ">
            ...
            <div className="h-[25vh] w-full overflow-hidden flex items-center justify-center lg:hidden my-6 relative">
