  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-400 min-h-screen flex flex-col pb-24 relative">
        ...
        <div className="h-[80vh] flex items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto  mt-12">
          <div className="w-full bg-gradient-to-r py-6 relative">
            <h1 className="text-center lg:text-left w-full px-3 sm:px-0 sm:w-3/4 mx-auto text-5xl sm:text-6xl lg:text-8xl drop-shadow-lg shadow-black text-white font-bold z-[100]">
            ...
            <Image
              ...
              width={256}
              height={256}
              className="w-full absolute top-0 group-hover:-translate-y-3 group-hover:scale-105 duration-100 py-6 mx-auto lg:hidden"
            />
            <h2 className="w-4/5 sm:w-3/5 lg:w-4/5 z-50 text-center lg:text-left mx-auto lg:mx-0 text-xl sm:text-2xl lg:text-4xl pt-12 drop-shadow-lg shadow-black text-white">
          ...
          <Image
            ...
            width={256}
            height={256}
            className="w-1/3 group-hover:-translate-y-3 group-hover:scale-105 duration-100 py-6 mx-auto lg:block hidden backdrop:"
          />
        </div>
