  ...
  return (
    <>
      ...
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col pb-24 relative overflow-x-hidden">
        ...
        <div className="h-max lg:h-[90vh] flex flex-col lg:justify-center items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-24 lg:mt-0">
          <div className="w-full h-max lg:h-full mx-auto lg:mx-0 bg-gradient-to-r ">
