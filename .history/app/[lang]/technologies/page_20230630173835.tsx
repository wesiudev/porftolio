...
export default function Technologies({ dictionary }: { dictionary: any }) {
  ...
  return (
    <>
      ...
      />
      <div className="w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 bg-opacity-85 min-h-screen flex flex-col relative overflow-x-hidden pb-24">
