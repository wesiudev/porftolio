        ...
        <div className="w-3/4 grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto transition-all duration-100 relative overflow-hidden">
          ...
          {dictionary["Technologies"].map((tech: any, idx: number) => (
            <div
              ...
              key={idx}
              className="relative p-3 bg-white flex flex-col duration-75 group rounded-lg"
            >
              ...
              <div className="flex items-center justify-center py-6 bg-gradient-to-r from-gray-400 via-white to-gray-400 h-[25vh]">
                <Image
                  ...
                  width={256}
                  height={256}
                  className="w-1/3 group-hover:-translate-y-3 group-hover:scale-105 duration-100 rounded-md"
                />
              </div>
