  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-400 min-h-screen flex flex-col pb-24 relative overflow-x-hidden">
        ...
        <div className="h-max flex flex-col items-center w-full lg:w-3/4 lg:flex-row lg:mx-auto mt-24">
          <div className="w-full h-max mx-auto lg:mx-0 bg-gradient-to-r ">
            ...
            <div className="h-[50vh] w-full overflow-hidden flex items-center justify-center lg:hidden">
              <Image
                unoptimized
