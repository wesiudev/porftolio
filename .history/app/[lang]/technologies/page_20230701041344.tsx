  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-3/4 grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto transition-all duration-100 relative">
          <div className="absolute -top-16 " id="1"></div>
          {dictionary["Technologies"].map((tech: any, idx: number) => (
            ...
            >
              ...
              <div className="flex items-center justify-center py-6 bg-gradient-to-r from-gray-400 via-white to-gray-400 h-[25vh]">
                <Image
                  unoptimized
                  src={tech.image}
              ...
              <div className="flex flex-col relative">
                ...
                <div className="min-h-[12vh] w-full">
                  <h2 className="bg-slate-500 text-white p-3 min-h-[10vh] cursor-default">
                    {tech.description}
                  </h2>
                </div>
              </div>
