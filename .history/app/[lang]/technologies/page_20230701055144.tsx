  ...
  return (
    <>
      ...
      <div
        className={`${
          isVisible
            ? "sm:rounded-[0] lg:rounded-[0]"
            : "sm:rounded-[125px] lg:rounded-[250px]"
        } duration-300 w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-hidden pb-24`}
      >
        <div
