  ...
  return (
    ...
    <>
      ...
      <main className="h-full flex flex-col justify-between relative w-full px-3 lg:px-0 lg:w-3/4 mx-auto min-h-screen bg-red-500">
        ...
        <div className="absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] h-max w-max duration-200 overflow-hidden  drop-shadow shadow-lg shadow-black z-50 flex justify-center items-center text-3xl">
