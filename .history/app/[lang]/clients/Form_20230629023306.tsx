...
export const Form = ({ dictionary }: { dictionary: any }) => {
  ...
  return (
    <>
      {" "}
      <div className="w-full lg:w-1/4 h-100 lg:h-max">
        <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12 w-max mx-auto lg:mx-0">
          {dictionary["Auth"].loginHeadline}
        </h1>
        <div className="h-1 bg-gray-600 w-24 mx-auto lg:mx-0 my-6" />
        <div className="my-6">
          <div>
