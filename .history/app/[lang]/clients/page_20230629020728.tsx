  ...
  return (
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans relative">
        <div className="bg-gradient-to-br linear-gradient hidden lg:flex items-center justify-start w-full  h-screen relative">
          <div className="flex flex-col text-white items-center lg:w-4/5 xl:w-3/4 bg-red-500 text-left">
        ...
        <div
          className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen lg:h-max px-6 lg:px-14 xl:px-12
