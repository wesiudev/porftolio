  ...
  return (
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans">
        <div className="bg-gradient-to-br from-zinc-900 via-white-900 to-purple-900 hidden lg:flex items-center justify-center w-full h-screen relative">
          <div className="flex flex-col text-white w-max mx-auto items-center text-center">
            <h1 className="text-3xl">
              Zaloguj się do swojego konta, aby zarządzać stroną.
            </h1>
