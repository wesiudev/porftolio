...
export default function ClientsPage() {
  ...
  return (
    <div className="w-full min-h-screen linear-gradient">
      <div className="flex flex-col lg:flex-row w-full px-3 lg:px-0  mx-auto">
        <div className="h-screen flex flex-col items-center justify-center w-full bg-red-500 text-center lg:text-left">
