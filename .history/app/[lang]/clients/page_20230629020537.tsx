    ...
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans relative">
        <div className="bg-gradient-to-br linear-gradient hidden lg:flex items-center justify-start w-full  h-screen relative">
          <div className="flex flex-col text-white w-max mx-auto items-center lg:w-4/5 xl:w-3/4 bg-red-500 text-center">
      ...
      flex items-center justify-center z-[1500] absolute right-0 top-[50%] -translate-y-[50%] lg:rounded-l-lg"
        >
