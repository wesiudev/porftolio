  ...
  return (
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans">
        <div className="bg-gradient-to-br from-zinc-900 via-white-900 to-purple-900 hidden lg:flex items-center justify-center lg:w-4/5 xl:w-3/4 h-screen relative">
