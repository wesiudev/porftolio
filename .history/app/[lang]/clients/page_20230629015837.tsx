  ...
  return (
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans">
        <div className="bg-gradient-to-br from-zinc-900 via-white-900 to-purple-900 hidden lg:flex items-center justify-center md:w-3/5 xl:w-2/3 h-screen relative">
          <div className="flex flex-col text-white w-max mx-auto ">
