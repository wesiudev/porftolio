...
export default async function ClientsPage({
  ...
  return (
    <>
      <section className="flex flex-col md:flex-row min-h-screen lg:h-screen items-center font-sans relative py-12">
        <div className="bg-gradient-to-br linear-gradient flex w-full h-[50vh] lg:h-screen relative">
