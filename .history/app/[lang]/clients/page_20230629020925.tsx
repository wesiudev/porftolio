    ...
    <>
      <section className="flex flex-col md:flex-row h-screen items-center font-sans relative">
        <div className="bg-gradient-to-br linear-gradient hidden lg:flex w-full  h-screen relative">
          <div className="flex flex-col text-white items-center lg:w-3/4 xl:w-3/4 bg-red-500 text-left">
        ...
        <div
          className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto lg:w-1/4 xl:w-1/3 h-screen lg:h-max px-6 lg:px-14 xl:px-12
