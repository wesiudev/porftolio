...
export default async function ProjectsPage({
  ...
  return (
    <>
      <div className=" w-full min-h-screen bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 background-animate-projects delay-500 flex items-center relative ">
