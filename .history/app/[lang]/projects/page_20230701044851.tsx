...
export default function ProjectsPage({ dictionary }: { dictionary: any }) {
  return (
    <>
      ...
      />
      <div className="sm:rounded-t-[125px] lg:rounded-t-[250px] w-full min-h-screen bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 background-animate-projects delay-500 flex items-center relative overflow-x-hidden">
        <Animate>
