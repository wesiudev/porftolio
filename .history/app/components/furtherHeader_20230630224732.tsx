      ...
      <div className="w-[90vw] lg:w-3/4 h-full mx-auto flex flex-row items-center justify-between">
          ...
          <div className="w-max relative">
            ...
            <div className="translate-y-[-50vh] opacity-0  group-hover:opacity-100 group-hover:translate-y-0 hover:translate-y-12  ease-in-out absolute left-[50%] -translate-x-[50%] p-6 w-max pt-12 z-[5]">
              <div className="flex flex-col bg-white text-black px-6 py-6 relative rounded-lg text-xl">
                ...
                <Link
                  className="hover:bg-gray-200 duration-200 w-full pl-2 flex flex-row items-center relative py-1 justify-start"
                  href="https://www.youtube.com/@wesiudev"
                  target="_blank"
                >
                  <FaYoutube className="w-max mr-2 text-red-600" />
                  <span className="flex flex-row justify-between w-full">
                    @wesiudev
                    <span className="text-gray-200 ml-4 w-max">PL</span>
                  </span>
                </Link>
                <Link
                  className="hover:bg-gray-200 duration-200 w-full pl-2 flex flex-row items-center relative py-1 justify-start cursor-default"
                ...
                >
                  ...
                  <span className="flex flex-row justify-between">
                    @HighDefinitionCode{" "}
                    <span className="text-gray-200 ml-4 w-max">ENG</span>
                  </span>
                </Link>
              </div>
            </div>
        ...
        <div className=" text-white w-full h-full flex items-center rounded-md bg-slate-600">
          <div className="group relative w-max mx-auto">
            <Link
              className="font-bold text-xl z-[150] bg-slate-700 px-3 py-2 rounded-md"
              href={`/${lang}`}
            >
