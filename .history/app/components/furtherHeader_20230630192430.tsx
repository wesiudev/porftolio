      ...
      <div className="w-[90vw] lg:w-3/4 h-full mx-auto flex flex-row items-center justify-between">
        ...
        <div className=" text-white w-full h-full flex items-center rounded-md">
          <div className="group relative w-max mx-auto">
            ...
            <div className="translate-y-[-50vh] group-hover:translate-y-0 hover:translate-y-12 duration-300 absolute left-[50%] -translate-x-[50%] min-h-[30vh] w-max w-max  pt-20">
