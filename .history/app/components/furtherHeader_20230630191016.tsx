...
export default function FurtherHeader({ location, lang }: FurtherHeaderProps) {
  ...
  return (
    ...
    >
      <div className="w-[90vw] bg-red-500 lg:w-3/4 h-full mx-auto flex flex-row items-center justify-between">
        <div className="bg-red-500"></div>
        <div className="text-white py-3 px-5 w-full rounded-md">
