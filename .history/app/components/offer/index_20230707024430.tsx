              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid grid-cols-3 gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    ...
                    style={{}}
                    key={idx}
                    className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black`}
                  >
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="hidden rounded-lg group-hover:block group-hover:z-[1500] bg-white p-3 text-black absolute left-[50%] -translate-x-[50%] top-12 w-[50vw]">
