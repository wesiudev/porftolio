      ...
      >
        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col">
              <span className="text-3xl mt-12 bg-blue-400  bg-clip-text text-transparent"></span>{" "}
              <span className="text-5xl text-white"> {chosenProduct.name}</span>
            </div>
            <div className="flex flex-col items-end mt-12">
              <span className="text-3xl mt-12 bg-blue-400  bg-clip-text text-transparent">
                Podstawowe usługi
              </span>{" "}
              <div className="text-xl sm:text-2xl lg:text-3xl xl:text-5xl text-white flex flex-col items-end">
