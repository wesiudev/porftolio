      ...
      >
        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-[90vw] lg:w-3/4 h-full   mx-auto">
            ...
            <div className="w-full text-5xl py-24 flex justify-end md:justify-center">
              <button className="bg-green-600 text-white rounded-lg py-6 px-12 w-full md:w-1/2 2xl:w-1/3">
          ...
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              ...
              <div className="flex flex-row w-full h-max items-center  text-white">
                ...
                <div className="h-full lg:w-1/2 mx-auto flex flex-col justify-between ">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-6xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                  ...
                  <button className="p-6 w-full bg-green-600 ">
