            ...
            <div className="flex flex-col  lg:mt-12">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white flex flex-col">
                ...
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div key={idx} className={`flex flex-col mt-3 z-${25 - idx}`}>
                    <div className="flex flex-row items-center mt-3 ">
                      <span className="italic">{service.name}</span>
                      <div className="text-white opacity-90 ml-2 text-lg relative">
                        <FaInfoCircle className="w-6 h-6  group" />
                        <div className="hidden group-hover:block bg-white p-3 text-black absolute left-[50%] -translate-x-[50%] top-12 w-[50vw]">
