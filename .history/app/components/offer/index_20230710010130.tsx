              ...
              <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
                <div className="h-full flex flex-col justify-between w-full lg:p-3 ">
                  <div className="flex flex-col w-full mt-3 lg:mt-0">
                    <span className="lg:text-blue-400 text-3xl md:text-3xl 2xl:text-5xl font-bold drop-shadow-lg shadow-black px-3 lg:px-0">
                      {" "}
                      {chosenProduct.name}
                    </span>
                    <span className="text-white text-lg xl:text-xl mt-6 hidden md:block ">
                      {chosenProduct.description}
                    </span>
                    <div className="flex flex-row items-end px-3 lg:px-0">
                      <div className="flex flex-col">
                    ...
                    <button className="max-h-12 w-full lg:w-max font-bold bg-green-600 px-3 py-2 mt-6 hover:bg-green-500 rounded-b-lg md:rounded-br-none sm:rounded-bl-lg lg:rounded-lg">
