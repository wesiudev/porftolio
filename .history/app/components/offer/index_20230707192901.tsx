      ...
      >
        ...
        {chosenProduct && isSummary && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              {/* price */}
              <div className="flex flex-row w-full h-3/4 items-center   text-white">
                <div className="w-full justify-end items-end bg-red-500  lg:flex hidden">
                  <Image
                    className="rounded-lg h-3/4 w-auto"
                    width={512}
                    height={512}
                ...
                <div className="h-3/4 lg:w-1/2 mx-auto flex flex-col justify-between sm:px-5">
