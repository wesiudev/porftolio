    ...
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      {hoveredText && (
        <div className="fixed bottom-6 left-0 w-full z-[1500] ">
          <div className="flex flex-col w-full px-3 lg:w-3/4 mx-auto bg-white rounded-lg lg:p-6 text-center lg:text-left sm:text-xl lg:text-2xl">
