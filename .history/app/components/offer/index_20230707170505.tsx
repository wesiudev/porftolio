                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    ...
                    >
                      ...
                      <div
                        className={`text-green-400 flex flex-row items-center bg-white drop-shadow-lg shadow-black p-6 w-max rounded-full duration-300 ease-in-out absolute -bottom-12 -left-3 z-50 ${
                          chosenProduct.services.includes(service)
                            ? "scale-100"
                            : "scale-0"
                        }`}
