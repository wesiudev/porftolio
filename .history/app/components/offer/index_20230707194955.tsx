      ...
      >
        ...
        {chosenProduct && isSummary && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              {/* price */}
              <div className="flex flex-col w-full justify-between items-between gap-y-3 lg:gap-y-0 py-6 text-white">
                <div className="flex flex-row justify-between w-full">
                  <div className="flex flex-col ">
                    <span className="text-lg w-max lg:text-2xl 2xl:text-3xl  text-blue-400 font-bold drop-shadow-lg shadow-black">
                      {dictionary.CustomerHook.toolBasicServices}
                    </span>
                    <span className="text-2xl  drop-shadow-lg shadow-black mt-3">
                      {expectedTime * 55} PLN
                    </span>
                  </div>
