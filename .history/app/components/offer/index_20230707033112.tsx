        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            <div className="flex flex-col">
              <h1 className="w-max text-5xl mx-auto mt-24 text-white">
            ...
            <div className="flex flex-col lg:mt-12 w-full ">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid grid-cols-3 gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    data-aos="fade-up"
                    data-aos-delay={100}
                    key={idx}
                    className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg hover:bg-slate-600 hover:border-2 hover:border-slate-800 border-2 border-transparent group`}
                  >
                    <div
                      className={`flex flex-col group-hover:scale-110 items-center text-center sm:text-left mx-auto text-2xl`}
                    >
                      <span className="text-blue-400 group-hover:scale-105 scale-100">
                        {service.name}
                      </span>
                    ...
                    <div className="flex flex-col h-full justify-end ">
                      ...
                      <div className={`flex flex-col lg:flex-row w-full`}>
                        ...
                        >
                          <div className="flex flex-col w-1/2 items-end px-6">
                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    <div
                      ...
                      data-aos-delay={100}
                      key={idx}
                      className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg hover:bg-slate-600 hover:border-2 hover:border-slate-800 border-2 border-transparent hover:scale-105`}
                    >
                      <div
                        className={`flex flex-col  items-center text-center sm:text-left mx-auto text-2xl`}
                      >
