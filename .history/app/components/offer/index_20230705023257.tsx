    ...
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 lg:bottom-6 left-0 w-full z-[5000]">
          <div className="flex flex-col w-full h-screen lg:w-3/4 mx-auto bg-white rounded-t-lg lg:rounded-lg lg:p-6 sm:text-xl lg:text-2xl overflow-y-scroll overflow-x-hidden pb-12 lg:pb-0">
