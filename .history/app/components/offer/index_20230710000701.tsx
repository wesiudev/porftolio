        ...
        {chosenProduct && isSummary && (
          ...
          >
            <div
              ...
              className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 h-max mx-auto bg-slate-700 p-3 rounded-b-lg`}
            >
              {/* price */}
              <div className="flex flex-row w-full h-max items-center text-white">
                ...
                <div className="flex flex-col h-full w-full">
                  ...
                  <button className="p-6 w-full lg:w-full bg-green-600  mt-6 hover:bg-green-500 rounded-lg">
            ...
            >
              ...
              <div className="flex flex-col w-full justify-between items-center gap-y-3 lg:gap-y-0 mb-12 pt-3 text-white">
                <div className="flex flex-col sm:grid sm:grid-cols-2 md:flex-row sm:justify-between w-full">
