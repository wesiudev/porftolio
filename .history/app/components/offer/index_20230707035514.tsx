              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid md:grid-cols-2 xl:grid-cols-3 gap-3 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    ...
                    data-aos-delay={100}
                    key={idx}
                    className={`flex flex-col p-6 sm:p-3 lg:p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg `}
                  >
                    <div
                      className={`flex flex-col  items-center text-center md:text-left mx-auto text-2xl`}
                    >
