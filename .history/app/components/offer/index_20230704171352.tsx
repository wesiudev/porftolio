  ...
  return (
    ...
    >
      <div
        className={`${
          isVisible
            ? "fixed bottom-20 left-[50%] -translate-x-[50%] bg-gradient-to-r from-green-500 to-blue-500 "
            : ""
        } px-3 w-full lg:px-0 lg:w-3/4 mx-auto h-max text-white flex flex-col justify-center items-center`}
      >
