    ...
    <section className={`min-h-screen w-full relative flex-col `}>
      ...
      >
          ...
          <div className="w-[90vw] lg:w-3/4 h-full   mx-auto">
            ...
            <div className="flex flex-col lg:mt-12 w-full lg:w-full lg:mx-auto cursor-default select-none">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid md:grid-cols-2 2xl:grid-cols-3 gap-3 mt-12 relative">
                <div
                  className="h-screen absolute -left-24 -top-[50vh]"
                  id="scrollToGrid"
                ></div>
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    ...
                    >
                      ...
                      <div
                        className={` text-xl group text-green-400 flex flex-row w-1/2 justify-center  mx-auto items-center bg-white drop-shadow-lg shadow-black px-6 py-2 my-2  rounded-full duration-300 ease-in-out  ${
                          chosenProduct.services.includes(service)
                            ? "scale-100 relative"
            ...
            <div className="w-full text-5xl py-24 flex justify-center">
              <button
        ...
        {chosenProduct && isSummary && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            <div
              className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 mx-auto bg-slate-700 p-3 rounded-b-lg`}
            >
              {/* price */}
              <div className="flex flex-row-reverse w-full h-max items-center text-white">
                <div className="h-full w-full lg:flex justify-center items-center overflow-hidden hidden">
                  <Image
                    className="rounded-lg h-full w-max object-cover"
                    width={512}
                    height={512}
                ...
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full pr-6 ">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-4xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                    <span className="text-white text-lg xl:text-xl mt-6">
                      {chosenProduct.description}
                    </span>
                    <span className="text-blue-400 text-4xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black mt-12 md:mt-24">
                      {dictionary.CustomerHook.toolTime}
                    </span>
                    <span className="text-3xl xl:text-4xl mt-3">
                      <span className="text-green-600">{expectedTime}</span>{" "}
                      {dictionary.CustomerHook.toolHours}
                    </span>
                  </div>
                  <button className="p-6 w-full lg:w-full bg-green-600 sm:mt-24 lg:mt-12 lg:my-0 hover:bg-green-500">
            ...
            >
              {/* price */}
              <div className="flex flex-col w-full justify-between items-center gap-y-3 lg:gap-y-0 py-6 text-white">
                <div className="flex flex-col sm:flex-row sm:justify-between w-full">
                  <div className="flex flex-col ">
                    <span className="text-xl lg:text-2xl 2xl:text-3xl  text-blue-400 font-bold drop-shadow-lg shadow-black">
                      {dictionary.CustomerHook.toolBasicServices}
                    </span>
                    <span className="text-4xl  drop-shadow-lg shadow-black mt-3">
                      {expectedTime * 55} PLN
                    </span>
                  </div>
                  <div className="flex flex-col ">
