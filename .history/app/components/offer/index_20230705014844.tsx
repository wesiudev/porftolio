            ...
            (template: any, idx: number) => (
              ...
              >
                ...
                <span
                  ...
                  className="group-hover:scale-110 duration-150 text-lg text-white absolute z-50 left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:text-2xl w-max cursor-default select-none "
                >
                  {template.name}
                </span>
                <button className="absoulte bottom-6 left-[50%] -translate-x-[50%] bg-green-500 text-white">
