...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section
      ref={nodeRef}
      className={`min-h-screen min-w-screen relative mt-36 flex items-center justify-center overflow-hidden`}
    >
      <div className="w-[100vw] h-[100vw] mt-36 linear-gradient rotate-45 z-50">
        asd
      </div>
      {/* <div
