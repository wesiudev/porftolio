...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      <div className="w-full min-h-screen bg-slate-600 mt-60 p-6 relative">
        <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
          ...
          <div className="flex flex-col">
            <span className="text-3xl mt-12 bg-gradient-to-r from-blue-600 to-orange-600 animate-pulse bg-clip-text text-transparent">
              Wycena dla
            </span>{" "}
