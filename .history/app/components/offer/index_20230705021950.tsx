        ...
        <div className="fixed top-0 lg:bottom-6 left-0 w-full z-[5000]">
          <div className="lg:hidden flex flex-col w-full h-screen lg:w-3/4 mx-auto bg-white rounded-t-lg lg:rounded-lg lg:p-6 sm:text-xl lg:text-2xl overflow-scroll pb-12 lg:pb-0">
            <div className="relative">
              <FaArrowAltCircleLeft className="h-16 w-16 text-white absolute left-6 top-6 drop-shadow-lg shadow-black" />
            ...
            <div className="w-full h-full grid grid-cols-2 gap-3 px-3 pt-3">
