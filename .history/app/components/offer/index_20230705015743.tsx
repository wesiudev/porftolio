          ...
          {dictionary.CustomerHook.templates.map(
            (template: any, idx: number) => (
              ...
              >
                ...
                <button
                  className={`absolute translate-y-12 group-hover:-translate-y-12 ${
                    hoveredText.name !== "" && "-translate-y-12"
                  } duration-200 left-[50%] -translate-x-[50%] bg-green-500 text-white`}
                >
