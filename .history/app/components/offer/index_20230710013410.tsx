    ...
    <section className={`min-h-screen w-full relative flex-col `}>
            ...
            <div className="flex sm:flex-row h-full relative">
              ...
              <div className="flex flex-col h-full mt-3">
                ...
                <button
                  ...
                  className="bg-gray-300 rounded-md w-max px-3 py-1 ml-3 mt-3 mb-3 md:mb-0"
                >
      ...
      >
        ...
        <div
          ...
          className={`${
            chosenProduct && isSummary ? "z-[1500]" : "z-[-500]"
          } fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14 `}
        >
          <div
            onClick={(e: any) => {
              e.stopPropagation();
            }}
            className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 h-max mx-auto bg-slate-700  rounded-b-lg duration-500  ${
            ...
            <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
              <div className="h-full flex flex-col justify-between w-full  ">
                <div className="flex flex-col w-full mt-3">
                  ...
                  <button className="max-h-12 lg:max-h-24 w-full font-bold bg-green-600 px-3 py-2 lg:py-4 mt-6 hover:bg-green-500 rounded-b-lg md:rounded-br-none sm:rounded-bl-lg">
          ...
          <div
            className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 mx-auto bg-slate-700 px-3 rounded-t-lg duration-500  ${
              chosenProduct && isSummary
