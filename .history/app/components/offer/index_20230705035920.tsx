  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      <div
        data-aos="fade-up"
        data-aos-delay={100}
        className={`linear-gradient px-3 w-full text-center lg:px-0 xl:w-3/4 mx-auto h-max text-white flex flex-col justify-center items-center rounded-lg pb-3 sm:mb-6 lg:mb-12`}
      >
        <div>
      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-28 left-0 sm:h-max w-full z-[5000]">
          <div
            onMouseOver={() =>
              width > 1024 &&
              setHoveredText({
            ...
            className=" flex flex-col w-full h-screen sm:h-max lg:w-3/4 mx-auto drop-shadow-lg shadow-black bg-white rounded-t-lg lg:rounded-lg lg:p-6 sm:text-xl lg:text-2xl overflow-scroll pb-12 sm:pb-0 lg:overflow-hidden"
          >
            ...
            <div className="flex lg:flex-row items-center">
              <img
                className="h-48 hidden sm:block rounded-lg"
                src={hoveredText.img}
                alt="Product"
              />
