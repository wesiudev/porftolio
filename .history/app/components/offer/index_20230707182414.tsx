                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    <div
                      ...
                      data-aos-delay={100}
                      key={idx}
                      className={`flex flex-col p-2 py-4 sm:p-3 sm:py-6 2xl:p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg relative`}
                    >
                      <div
                        className={`flex flex-col  items-center text-center mx-auto text-2xl`}
                      >
        ...
        {chosenProduct && (
          <div className={`flex flex-col  mt-6 w-[90vw] lg:w-3/4 mx-auto`}>
            <div className="flex flex-row w-full justify-between">
              <div className="flex flex-col ">
                <span className="text-xl lg:text-3xl mt-12 text-blue-400 font-bold drop-shadow-lg shadow-black">
                  {dictionary.CustomerHook.toolPrice}
                </span>
                <span className="text-4xl text-white drop-shadow-lg shadow-black my-6">
                  {expectedTime * 55} PLN
                </span>
              </div>
              <div className="flex flex-col ">
                <span className="text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl mt-12 text-blue-400 font-bold drop-shadow-lg shadow-black">
