    ...
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-3 lg:top-6 left-0 sm:h-max w-full z-[5000]">
          <div className="flex flex-col w-full h-screen sm:h-max lg:w-3/4 mx-auto bg-white rounded-t-lg lg:rounded-lg lg:p-6 sm:text-xl lg:text-2xl overflow-scroll pb-12 sm:pb-0 lg:overflow-hidden">
            ...
            <span className="text-xl font-bold pt-6 sm:py-3 lg:pt-0 p-3 lg:text-3xl">
              {hoveredText.itemName}
            </span>
            <span className="italic py-3 sm:py-0 p-3">
          ...
          {dictionary.CustomerHook.templates.map(
            (template: any, idx: number) => (
              ...
              >
                ...
                <button
                  className={`px-3 py-2 absolute translate-y-12 group-hover:lg:-translate-y-16 duration-200 left-[50%] -translate-x-[50%] bg-green-500 text-white`}
                >
