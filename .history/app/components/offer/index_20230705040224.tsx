      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-28 left-0 sm:h-max w-full z-[5000]">
          <div
            ...
            className=" flex flex-col w-full h-screen sm:h-max lg:w-3/4 mx-auto drop-shadow-lg shadow-black bg-white rounded-t-lg lg:rounded-lg sm:p-6 sm:text-lg lg:text-xl overflow-scroll pb-12 sm:pb-0 sm:overflow-hidden"
          >
