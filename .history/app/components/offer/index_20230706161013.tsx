        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col lg:mt-12 w-full ">
              <span className="text-3xl lg:text-5xl mt-12 text-blue-400 font-bold w-max mx-auto">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid grid-cols-2 gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    style={{ zIndex: 25 - idx }}
                    key={idx}
                    className={`flex flex-col mt-3 p-6 bg-slate-800`}
                  >
                    <div className={`flex flex-row items-center w-max mx-auto`}>
                    ...
                    <span className="text-lg w-max mx-auto">
                    ...
                    <div className={`flex flex-col lg:flex-row  w-full`}>
                      <div className={`w-full flex flex-row items-center  `}>
                        ...
                        <FaClock className="w-12 h-12 mr-2" />
