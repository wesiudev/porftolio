...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section className="min-h-screen min-w-screen">
      <div ref={nodeRef} className={`${isVisible ? "fixed bottom-20 left-[50%] -translate-x-[50%]"} px-6 lg:px-0 lg:w-3/4 mx-auto h-max text-black flex flex-col justify-center items-center`}>
