            ...
            >
              ...
              <div className="flex flex-row w-full h-max items-center  text-white">
                <div className="h-full  w-max   lg:flex hidden">
                  <Image
                    className="rounded-lg h-full w-auto p-6"
                    width={512}
                    height={512}
                ...
                <div className="h-full lg:w-1/2 mx-auto flex flex-col justify-between ">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-2xl md:text-2xl  2xl:text-6xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                  ...
                  <button className="p-6 w-full bg-green-600 mt-12 md:my-0">
