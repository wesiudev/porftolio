              ...
              <div className="h-full flex flex-col justify-between w-full relative">
                {checkAvailability && (
                  <div className="absolute -bottom-[66.6%] left-0 w-full h-2/3 p-3 bg-slate-700 rounded-b-lg">
                    <h1>
                      Aktualnie nie pracuję nad żadnym projektem, wpisz swój
                      adres email lub numer telefonu, a ja się z Tobą
                      skontaktuję w celu ustalenia szczegółów
                    </h1>
                    <div className="flex flex-row flex-wrap mt-3"></div>
                  </div>
                )}
