  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
            ...
            (template: any, idx: number) => (
              ...
              >
                ...
                <ScrollLink
                  ...
                  className={`hover:bg-green-400 px-3 py-2 font-bold absolute translate-y-12 group-hover:lg:-translate-y-16 duration-200 left-[50%] -translate-x-[50%] bg-green-500 text-white`}
                >
      ...
      <div
        ...
        } w-full  bg-slate-600 mt-60 p-6 relative`}
      >
        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col">
              <span className="text-3xl lg:text-4xl mt-12 bg-blue-400  bg-clip-text text-transparent">
                {dictionary.CustomerHook.toolPriceFor}
              </span>{" "}
              <span className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white">
                {" "}
                {chosenProduct.name}
              </span>
            </div>
            <div className="flex flex-col items-end mt-12">
              <span className="text-3xl mt-12 bg-blue-400  bg-clip-text text-transparent">
                {dictionary.CustomerHook.toolBasicServices}
              </span>{" "}
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white flex flex-col items-end">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div key={idx} className="">
                    <span className="mt-3">{service.name}</span>
                  </div>
                ))}
              </div>
            </div>
