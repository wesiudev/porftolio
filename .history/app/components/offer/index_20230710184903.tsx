          ...
          >
            ...
            <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
              <div className="h-full flex flex-col justify-between w-full relative">
                {checkAvailability && (
                  <div className="absolute -bottom-[66.6%] left-0 w-full h-2/3 p-3 bg-slate-700 rounded-b-lg">
                    ...
                    <div className="flex items-center justify-center h-full w-full">
                      <div className="grid grid-cols-3 gap-x-3 w-full">
                        ...
                        <div className="flex items-end h-full w-full p-3">
                          <button className="bg-blue-500 w-full  text-white font-bold flex flex-row items-center justify-center text-2xl">
                            Wyślij
                            <FaEnvelope className="ml-3 h-6 w-6" />
                          </button>
                        </div>
                      </div>
                    </div>
