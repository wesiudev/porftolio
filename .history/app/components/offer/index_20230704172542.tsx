...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section
      ref={nodeRef}
      className={`min-h-screen min-w-screen relative pt-36 flex items-center justify-center`}
    >
      <div className="min-w-screen min-h-screen linear-gradient rotate-45 z-50"></div>
      {/* <div
