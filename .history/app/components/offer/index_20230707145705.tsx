...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section className={`min-h-screen w-full relative flex-col `}>
            ...
            <div className="flex sm:flex-row items-center h-full relative">
              ...
              <div className="flex flex-col  h-full  ">
                ...
                <button
                  ...
                  className="bg-gray-300 rounded-md w-max py-1 ml-3 xl:absolute right-3 bottom-3"
                >
      ...
      <div className="w-[90vw] h-max flex flex-col mt-6 px-3 lg:px-0 lg:w-4/5 mx-auto rounded-lg z-50 ">
