...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section
      ref={nodeRef}
      className={`min-h-screen min-w-screen relative  flex items-center justify-center overflow-x-hidden`}
    >
      <div className="w-[100vw] h-[100vw]  linear-gradient rotate-45 z-50">
