      ...
      >
        ...
        {chosenProduct && isSummary && (
          ...
          >
            ...
            >
              {/* price */}
              <div className="flex flex-row-reverse w-full h-max lg:h-2/3 items-center text-white">
                <div className="h-full w-full lg:h-2/3 lg:flex justify-center items-center overflow-hidden hidden">
                  <Image
                    className="rounded-lg h-full lg:h-2/3 w-max object-cover"
                    width={512}
                    height={512}
