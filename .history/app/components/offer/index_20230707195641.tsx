              ...
              <div className="flex flex-row-reverse w-full h-max items-center text-white">
                ...
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full lg:pr-6 ">
                  <div className="flex flex-col w-full ">
                    ...
                    <span className="text-blue-400 text-4xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black lg:mt-12 md:mt-24">
                  ...
                  <button className="p-6 w-full lg:w-full bg-green-600 sm:mt-24 lg:mt-12 mt-6 hover:bg-green-500">
