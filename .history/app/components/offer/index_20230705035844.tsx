  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      <div
        data-aos="fade-up"
        data-aos-delay={100}
        className={`linear-gradient px-3 w-full text-center lg:px-0 sm:w-3/4 mx-auto h-max text-white flex flex-col justify-center items-center rounded-lg pb-3 sm:mb-6 lg:mb-12`}
      >
        <div>
