      ...
      >
        ...
        {chosenProduct && isSummary && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              {/* price */}
              <div className="flex flex-row w-full h-max items-center text-white">
                ...
                <div className="h-full lg:pl-6 flex flex-col justify-between ">
                  <div className="flex flex-col w-full ">
                    ...
                    <span className="text-3xl xl:text-4xl mt-6">
                      <span className="text-green-600">{expectedTime}</span>h
                    </span>
                  </div>
                  <button className="p-6 w-full bg-green-600 mt-12 lg:my-0 hover:bg-green-500">
