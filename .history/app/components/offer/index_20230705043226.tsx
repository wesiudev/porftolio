  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
          ...
          >
            ...
            <div className="flex sm:flex-row items-center h-full relative">
              <Image
                ...
                blurDataURL="data:image/png;base64,"
                src={hoveredText.img}
                alt="Product"
              />
      ...
      <div className="w-full h-max flex flex-col mt-6 px-3 lg:px-0 lg:w-3/4 mx-auto rounded-lg z-50">
            ...
            (template: any, idx: number) => (
              ...
              >
                ...
                <Link
                  href="#tool"
                  onClick={() => {
                    setChosenProduct(template), console.log(chosenProduct);
                  }}
        ...
        <div id="tool" className="w-full h-screen bg-slate-600 mt-60 p-6"></div>
      </div>
    </section>
  );
}
