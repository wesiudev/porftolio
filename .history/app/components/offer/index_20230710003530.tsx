            ...
            >
              ...
              <div className="flex flex-col lg:flex-row w-full h-max items-center text-white">
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full lg:pr-6 ">
                  <div className="flex flex-col w-full mt-12 lg:mt-0 relative">
                    ...
                    <div className="flex flex-row h-full bg-red-500 absolute bottom-3 left-3">
                      <div className="flex flex-col">
                      ...
                      <button className="p-6 w-full lg:w-max bg-green-600  mt-6 hover:bg-green-500 rounded-lg">
