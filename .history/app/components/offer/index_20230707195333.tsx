          ...
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              ...
              <div className="flex flex-row-reverse w-full h-max items-center text-white">
                ...
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full lg:pr-6 ">
                  ...
                  <button className="pb-7 lg:p-6 w-full lg:w-full bg-green-600 sm:mt-24 lg:mt-12  hover:bg-green-500">
