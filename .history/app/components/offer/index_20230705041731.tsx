      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-28 left-0 sm:h-max w-full z-[5000] sm:px-6 lg:px-0">
          <div
            ...
            className=" flex flex-col w-full h-screen sm:h-full lg:w-3/4 mx-auto drop-shadow-lg shadow-black bg-white rounded-t-lg sm:rounded-lg sm:p-3 sm:text-lg lg:text-xl overflow-scroll pb-12  sm:overflow-hidden"
          >
            ...
            <div className="flex sm:flex-row justify-between h-full bg-green-500">
              <img
                className="h-64 xl:h-52 hidden md:block rounded-lg"
                src={hoveredText.img}
                alt="Product"
              />
              <div className="flex flex-col justify-between h-full bg-red-500 relative">
                ...
                <button className="bg-gray-300 rounded-md w-max px-3 py-1 ml-3 absolute left-3 bottom-0">
