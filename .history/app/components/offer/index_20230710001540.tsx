          ...
          >
              ...
              <div className="flex flex-col lg:flex-row w-full h-max items-center text-white">
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full lg:pr-6 ">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-2xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                    ...
                    <span className="text-blue-400 text-xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black">
            ...
            >
              ...
              <div className="flex flex-col w-full justify-between items-center gap-y-3 lg:gap-y-0 mb-12 pt-3 text-white">
                <div className="flex flex-col items-center sm:grid sm:grid-cols-2 md:flex md:flex-row sm:justify-between w-full">
                  ...
                  <div className="flex flex-col mt-3">
                    <span className="text-2xl lg:text-2xl 2xl:text-3xl md:text-center text-blue-400 font-bold drop-shadow-lg shadow-black">
                      {dictionary.CustomerHook.toolExtraServices}
                    </span>
                    <span className="text-xl text-center sm:text-left drop-shadow-lg shadow-black ">
                      {500}
                      {",00"} PLN
                    </span>
                  </div>
