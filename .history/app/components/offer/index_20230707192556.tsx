          ...
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              ...
              <div className="flex flex-row w-full h-max items-center  text-white">
                <div className="h-full  w-max   lg:flex hidden">
                  <Image
                ...
                <div className="h-full lg:w-1/2 mx-auto flex flex-col justify-between sm:px-5">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-4xl md:text-3xl  2xl:text-6xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                    <span className="text-white text-lg lg:text-xl mt-6">
