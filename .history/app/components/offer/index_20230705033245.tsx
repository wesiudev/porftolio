  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-20 left-0 sm:h-max w-full z-[5000]">
          <div
            onMouseOver={() =>
              width > 1024 &&
              setHoveredText({
          ...
          {dictionary.CustomerHook.templates.map(
            (template: any, idx: number) => (
              ...
              >
                ...
                <button className="opacity-0 group-hover:opacity-100 text-white duration-1000 absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[-100%]">
                  {"("}Dowiedz się więcej{")"}
                </button>
                <button
