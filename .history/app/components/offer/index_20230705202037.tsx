...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section className={`min-h-screen min-w-screen relative flex-col`}>
      ...
      <div className="w-full h-max flex flex-col mt-6 px-3 lg:px-0 lg:w-3/4 mx-auto rounded-lg z-50 overflow-x-hidden">
                ...
                {chosenProduct.services?.map((service: any, idx: number) => (
                  ...
                  >
                    ...
                    <div className={`flex flex-col lg:flex-row  w-full`}>
                      ...
                      >
                        <span className="text-5xl text-green-500">Design</span>
                        <span className="text-lg ">
