      ...
      >
        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col">
              {/* left */}
              <span className="text-3xl lg:text-4xl mt-12 text-blue-400 italic font-bold">
            ...
            <div className="flex flex-col items-end lg:mt-12">
              {/* right */}
              <span className="text-3xl lg:text-4xl mt-12 text-blue-400 items-end italic font-bold">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white flex flex-col items-end">
                ...
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div key={idx} className="flex flex-col mt-3">
                    <span className="mt-3 font-light ">{service.name}</span>
