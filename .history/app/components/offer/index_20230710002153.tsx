              ...
              <div className="flex flex-col lg:flex-row w-full h-max items-center text-white">
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full lg:pr-6 ">
                  <div className="flex flex-col w-full mt-12 lg:mt-0">
                    <span className="lg:text-blue-400 text-2xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black">
                      {" "}
                      {chosenProduct.name}
                    </span>
                    <span className="text-white text-xl xl:text-xl mt-6 hidden lg:block">
                      {chosenProduct.description}
                    </span>
                    <span className="text-blue-400 text-xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black mt-6 lg:mt-0">
