          ...
          >
            ...
            <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
              <div className="h-full flex flex-col justify-between w-full relative">
                {checkAvailability && (
                  <div className="absolute translate-y-[50%] -bottom-[70%] left-0 w-full min-h-full p-3 bg-slate-700 rounded-b-lg">
                    <h1 className="text-xl">
                      <span className="text-green-500 flex flex-row items-center mb-6">
                        {" "}
                        <FaFire className="text-red-500 h-6 w-6 mr-2" />{" "}
                        Aktualnie nie pracuję nad żadnym projektem
                      </span>
                    ...
                    <div className="flex items-center justify-center h-full w-full z-[100]">
                      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-3 w-full">
                        <div className="flex flex-col">
                          <label
                            htmlFor="contact"
                        ...
                        <div className="flex flex-col">
                          ...
                          <input
                            ...
                            id="contact"
                            type="text"
                            className="py-5 lg:py-3 lg:p-3 outline-1 outline-blue-500 focus:rounded-none text-black"
                          />
                        </div>
                        <div></div>
                        <div className="flex items-end h-full w-full mt-3 lg:mt-0">
                          <button className="bg-blue-500 w-full h-3/4 rounded-lg text-white font-bold flex flex-row items-center justify-center text-2xl">
                            Wyślij
