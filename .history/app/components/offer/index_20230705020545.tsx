          ...
          {dictionary.CustomerHook.templates.map(
            (template: any, idx: number) => (
              ...
              >
                ...
                />
                <span className="text-sm group-hover:lg:scale-110 duration-150 sm:text-lg lg:text-xl text-white absolute z-50 left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:text-2xl w-max cursor-default select-none ">
                  {template.name}
                </span>
                <button
