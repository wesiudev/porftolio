                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    ...
                    >
                      ...
                      <div
                        className={`group text-green-400 flex flex-row w-max  mx-auto items-center bg-white drop-shadow-lg shadow-black px-6 py-2 my-2  rounded-full duration-300 ease-in-out  ${
                          chosenProduct.services.includes(service)
                            ? "scale-100 relative"
                            : "scale-0 absolute"
                        }`}
                      >
                        <FaCheck className="w-8 h-8 group-hover:hidden " />{" "}
                        <FaWindowClose className="w-8 h-8 hidden group-hover:block text-red-500" />
                        <span className="group-hover:hidden">
                          {" "}
                          {dictionary.CustomerHook.toolAdded}
                        </span>
                        <span className="group-hover:block text-red-500">
                          {dictionary.CustomerHook.toolAdded}
                        </span>
                      </div>
                    </div>
