      ...
      >
        ...
        {chosenProduct && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            <div
              className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 mx-auto bg-slate-700 px-3 rounded-b-lg`}
            >
              {/* price */}
            ...
            >
              {/* price */}
              <div className="flex flex-row w-full justify-between items-center h-max  text-white">
                <div className="flex flex-col ">
                  <span className="text-xl lg:text-4xl 2xl:text-5xl mt-12 text-blue-400 font-bold drop-shadow-lg shadow-black">
                    {dictionary.CustomerHook.toolBasicServices}
                  </span>
                  <span className="text-4xl  drop-shadow-lg shadow-black my-6">
                    {expectedTime * 55} PLN
                  </span>
                </div>
                <div className="flex flex-col ">
