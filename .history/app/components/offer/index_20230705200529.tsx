        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col items-end lg:mt-12">
              {/* right */}
              <span className="text-3xl lg:text-4xl mt-12 text-blue-400 items-end  font-bold">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white flex flex-col">
                ...
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    style={{ zIndex: 25 - idx }}
                    key={idx}
                    className={`flex flex-col mt-3 items-end`}
                  >
                    <div className="flex flex-row items-center ">
                      <div className="text-white opacity-90 mr-2 text-lg relative group">
                    ...
                    <div className="flex flex-col lg:flex-row items-start w-ful">
