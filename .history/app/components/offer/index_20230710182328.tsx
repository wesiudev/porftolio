          ...
          >
            ...
            <div className="flex sm:flex-row h-full relative">
              ...
              <div className="flex flex-col h-full mt-3">
                ...
                <span className="italic py-3  select-none lg:text-md px-3">
                ...
                <button
                  ...
                  className="bg-gray-300 rounded-md w-max px-3 py-1 ml-3 mb-3 pb-3 md:mb-0"
                >
                ...
                {checkAvailability && (
                  <div className="absolute -bottom-[66.6%] left-0 w-full h-2/3 p-3 bg-slate-700 rounded-b-lg">
                    <h1>
                      ...
                      , wpisz email lub numer telefonu, a ja skontaktuję się z
                      Tobą w celu ustalenia szczegółów.
                    </h1>
