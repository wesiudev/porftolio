        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-0 lg:w-3/4 mx-auto">
            ...
            <div className="flex flex-col lg:mt-12 w-full cursor-default select-none">
              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid sm:grid-cols-2 xl:grid-cols-3 sm:gap-3 lg:gap-3 xl:gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    data-aos="fade-up"
                    data-aos-delay={100}
                    key={idx}
                    className={`flex flex-col p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg `}
                  >
                    <div
                    ...
                    <div className="flex flex-col h-full justify-end ">
                      ...
                      <div className={`flex flex-col lg:flex-row w-full`}>
                        ...
                        >
                          <div className="flex flex-col  items-end w-max px-2 lg:px-4">
                          ...
                          <div className="flex flex-col  w-max px-2 lg:px-4">
                      ...
                      <div className="flex flex-col h-full justify-end ">
                        ...
                        <div className={`flex flex-col lg:flex-row w-full`}>
                          <div
                            className={`w-full flex flex-row items-center  text-2xl`}
                          >
                            <div className="flex flex-col w-max h-max items-end px-6">
                              <span className="text-xl text-green-500">
                                Design
                              </span>
                            ...
                            <FaClock className="w-12 h-12" />
                            <div className="flex flex-col w-max h-max px-6">
                              <span className="text-xl text-blue-400 ">
                                {dictionary.CustomerHook.toolLogic}
                              </span>
                              <span className="flex flex-row items-center text-2xl">
