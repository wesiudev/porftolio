              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid grid-cols-3 gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    ...
                    data-aos-delay={100}
                    key={idx}
                    className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg hover:bg-slate-600 hover:border-slate-800 border-2 border-transparent `}
                  >
                    <div
                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    <div
                      ...
                      data-aos-delay={100}
                      key={idx}
                      className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black rounded-lg hover:bg-slate-600  hover:border-slate-800 border-2 border-transparent hover:scale-105`}
                    >
                      <div
                        className={`flex flex-col  items-center text-center sm:text-left mx-auto text-2xl`}
                      >
