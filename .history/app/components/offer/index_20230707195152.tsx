      ...
      >
        ...
        {chosenProduct && isSummary && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
              ...
              <div className="flex flex-row-reverse w-full h-max items-center text-white">
                ...
                <div className="h-full lg:pl-6 flex flex-col justify-between w-full pr-6 ">
                  <div className="flex flex-col w-full ">
                    <span className="text-blue-400 text-4xl md:text-3xl  2xl:text-5xl font-bold drop-shadow-lg shadow-black hidden lg:block">
                      {" "}
                      {chosenProduct.name}
                    </span>
                  ...
                  <button className="p-6 w-full lg:w-full bg-green-600 sm:mt-24 lg:mt-12  hover:bg-green-500">
            ...
            >
              {/* price */}
              <div className="flex flex-col w-full justify-between items-center gap-y-3 lg:gap-y-0 mb-12 pt-3 text-white">
