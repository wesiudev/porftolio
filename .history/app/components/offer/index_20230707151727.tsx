                    ...
                    <div className="flex flex-col h-full justify-end ">
                      ...
                      <div className={`flex flex-col lg:flex-row w-full`}>
                        ...
                        >
                          ...
                          <div className="w-max h-max lg:w-10 lg:h-10 mx-6 xl:mx-5">
                            <FaClock className="w-12 h-12 lg:w-10 lg:h-10 " />
                          </div>
                      ...
                      <div className="flex flex-col h-full justify-end ">
                        ...
                        <div className={`flex flex-col lg:flex-row w-full`}>
                          ...
                          >
                            ...
                            <div className="w-max h-max lg:w-10 lg:h-10 mx-6 xl:mx-5 2xl:mx-8">
                              <FaClock className="w-12 h-12 lg:w-10 lg:h-10 " />
                            </div>
                            <div className="flex flex-col w-1/2 ">
