          ...
          >
            ...
            <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
              <div className="h-full flex flex-col justify-between w-full relative">
                {checkAvailability && (
                  <div className="absolute translate-y-[50%] lg:translate-y-12 -bottom-[70%] left-0 w-full min-h-full p-3 bg-slate-700 rounded-b-lg">
                    ...
                    <div className="flex items-end justify-center h-full w-full z-[100]">
                      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-3 w-full">
                        ...
                        <div className="flex items-end h-full w-full mt-3 lg:mt-0">
                          <button className="py-3 lg:py-3 lg:p-3  bg-blue-500 w-full h-3/4 rounded-lg text-white font-bold flex flex-row items-center justify-center text-2xl">
                            Wyślij
