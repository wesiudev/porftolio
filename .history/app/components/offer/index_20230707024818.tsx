              ...
              <div className="text-xl sm:text-2xl lg:text-4xl xl:text-5xl text-white grid grid-cols-3 gap-6 mt-12">
                {chosenProduct.services?.map((service: any, idx: number) => (
                  <div
                    ...
                    data-aos-delay={100}
                    key={idx}
                    className={`flex flex-col mt-3 p-6 bg-slate-800 drop-shadow-xl shadow-black relative`}
                  >
                    <div
                      className={`flex flex-row items-center w-max mx-auto text-2xl`}
                    >
                      <span className="">{service.name}</span>
                      <div
                        className={`text-white opacity-90 mx-2 text-lg  group`}
                      >
                        <FaInfoCircle className="w-6 h-6" />
                        <div className="hidden rounded-lg group-hover:flex group-hover:z-[1500] bg-white p-3 text-black absolute left-[50%] -translate-x-[50%] top-12 w-[50vw]">
                    ...
                    <div className={`flex flex-col lg:flex-row w-full`}>
                      ...
                      >
                        <div className="flex flex-col w-1/2 items-end px-6">
                          <span className="text-xl text-green-500">Design</span>
