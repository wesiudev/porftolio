...
export default function CustomerHook({ dictionary }: { dictionary: any }) {
  ...
  return (
    <section className={`min-h-screen w-full relative flex-col `}>
      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-28 left-0 sm:h-max w-full z-[5000] sm:px-6 lg:px-0">
          ...
          >
            ...
            <div className="w-full h-full grid grid-cols-2 sm:hidden ">
              {dictionary.CustomerHook.templates.map(
                (template: any, idx: number) => (
                  <div
                    ...
                    key={idx}
                    className="bg-white rounded-md overflow-hidden relative group"
                  >
                    <img
      ...
      <div className="w-[90vw] h-max flex flex-col mt-6 lg:px-0 lg:w-4/5 mx-auto rounded-lg z-50 ">
      ...
      >
        ...
        {chosenProduct.length !== 0 ? (
          <div className="w-full h-full px-3 lg:px-12 lg:w-full mx-auto">
            ...
            <div className="flex flex-col lg:mt-12 w-full lg:w-3/4 lg:mx-auto cursor-default select-none">
