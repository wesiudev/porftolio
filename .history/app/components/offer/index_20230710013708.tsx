        ...
        <div
          ...
          className={`${
            chosenProduct && isSummary
              ...
              : "z-[-500] bg-opacity-0"
          } fixed h-screen w-full bg-black duration-1000 ease-in-out flex flex-col justify-between left-0 top-0 pt-14 `}
        >
          <div
            onClick={(e: any) => {
              e.stopPropagation();
            }}
            className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 h-max mx-auto bg-slate-700 ease-in-out rounded-b-lg duration-500  ${
              chosenProduct && isSummary
          ...
          <div
            className={`flex flex-col mt-6 w-[90vw] lg:w-3/4 mx-auto bg-slate-700 px-3 ease-in-out rounded-t-lg duration-500  ${
              chosenProduct && isSummary
                ? "translate-y-0 delay-500"
                : "translate-y-[100vh]"
            }`}
