          ...
          >
            ...
            <div className="flex flex-col md:flex-row w-full h-max items-center text-white">
              <div className="h-full flex flex-col justify-between w-full relative">
                {checkAvailability && (
                  <div className="absolute -bottom-[100%] left-0 w-full h-full p-3 bg-red-500">
                    abc
                  </div>
                )}
                <div className="flex flex-col w-full mt-3">
                  ...
                  <button
                    ...
                    className={`max-h-12 lg:max-h-24 w-full font-bold bg-green-600 px-3 py-2 lg:py-4 mt-6 hover:bg-green-500 rounded-b-lg md:rounded-br-none ${
                      checkAvailability && "sm:rounded-bl-lg"
                    }`}
                  >
