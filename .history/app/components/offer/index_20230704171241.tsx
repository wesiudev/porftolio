  ...
  return (
    ...
    >
      <div
        className={`${
          isVisible
            ? "fixed bottom-20 left-[50%] -translate-x-[50%] bg-gradient-to-br from-green-500 via-blue-500 to-orange-500"
            : ""
        } px-6 lg:px-0 lg:w-3/4 mx-auto h-max text-white flex flex-col justify-center items-center`}
      >
