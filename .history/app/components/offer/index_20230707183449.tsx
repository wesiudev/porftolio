  ...
  return (
    <section className={`min-h-screen w-full relative flex-col `}>
      ...
      <div
        ...
        } w-full  bg-gradient-to-l from-slate-600 via-slate-500 to-slate-600 mt-60 bg-opacity-50 relative `}
      >
        ...
        {chosenProduct && (
          <div className="fixed h-screen w-full  bg-opacity-50 flex items-end justify-center left-0 top-0">
            <div
              className={`flex flex-col text-black mt-6 w-[90vw] lg:w-3/4 mx-auto`}
            >
              {/* price */}
