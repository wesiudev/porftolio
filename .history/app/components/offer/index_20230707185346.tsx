      ...
      >
        ...
        {chosenProduct && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              ...
              <div className="flex flex-row w-full h-max items-center justify-between text-white">
                <div className="h-full w-1/2 flex lg:items-end lg:justify-end">
                  <Image
                    className="rounded-lg h-1/2 lg:h-full w-auto"
                    width={512}
                    height={512}
            ...
            >
              {/* price */}
              <div className="flex flex-row w-full justify-between items-center py-6 text-white">
                ...
                <button className="h-1/2 font-bold text-xl px-6 bg-green-600 my-auto">
                  Sprawdź dostępność
                </button>
              </div>
            </div>
