          ...
          <div className={`flex flex-col  mt-6 w-[90vw] lg:w-3/4 mx-auto`}>
            <div className="flex flex-row w-full justify-between">
              <div className="flex flex-col ">
                ...
                <span className="text-4xl text-white drop-shadow-lg shadow-black">
                  {expectedTime * 55} PLN
                </span>
              </div>
              <div className="flex flex-col drop-shadow-lg shadow-black">
                <span className="text-3xl lg:text-5xl mt-12 text-blue-400 font-bold drop-shadow-lg shadow-black">
                  {dictionary.CustomerHook.toolTime}
                </span>
                <span className="text-4xl text-white">{expectedTime}h</span>
              </div>
            </div>
          </div>
        )}
