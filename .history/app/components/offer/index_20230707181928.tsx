                ...
                {dictionary.CustomerHook.toolAdditional.map(
                  (service: any, idx: number) => (
                    ...
                    >
                      ...
                      <div
                        className={` text-xl group text-green-400 flex flex-row w-1/2  mx-auto items-center bg-white drop-shadow-lg shadow-black px-6 py-2 my-2  rounded-full duration-300 ease-in-out  ${
                          chosenProduct.services.includes(service)
                            ? "scale-100 relative"
                            : "scale-0 absolute"
                        }`}
