      ...
      >
        ...
        {chosenProduct && (
          <div className="fixed h-screen w-full bg-black bg-opacity-75 flex flex-col justify-between left-0 top-0 pt-14">
            ...
            >
              {/* price */}
              <div className="flex flex-row w-full h-max items-center justify-between text-white">
                <div className="h-full  w-1/2 flex lg:items-end lg:justify-end">
                  <Image
            ...
            >
              {/* price */}
              <div className="flex flex-col lg:flex-row w-full justify-between lg:items-center gap-y-3 lg:gap-y-0 py-6 text-white">
                <div className="flex flex-col ">
                  <span className="text-xl lg:text-4xl 2xl:text-5xl  text-blue-400 font-bold drop-shadow-lg shadow-black">
                    {dictionary.CustomerHook.toolBasicServices}
                  </span>
                ...
                <button className="h-1/2 font-bold text-xl px-6 py-6 lg:py-0 bg-green-600 my-auto">
                  Sprawdź dostępność
                </button>
              </div>
            </div>
