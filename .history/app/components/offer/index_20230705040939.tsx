      ...
      {hoveredText.itemName !== "" && (
        <div className="fixed top-0 sm:top-28 left-0 sm:h-max w-full z-[5000] sm:px-6 lg:px-0">
          ...
          >
            ...
            <div className="flex lg:flex-row justify-between h-full bg-green-500 p-3">
              <img
              ...
              <div className="flex flex-col justify-between h-full bg-red-500">
                <span className="text-xl font-bold pt-6 sm:py-0 lg:text-2xl select-none">
                  {hoveredText.itemName}
                </span>
                <span className="italic py-3  select-none lg:text-md">
                  {hoveredText.itemDescription}
                </span>
                <button className="bg-gray-300 rounded-md w-max px-3 py-1">
