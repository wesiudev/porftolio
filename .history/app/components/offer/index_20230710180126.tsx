              ...
              <div className="h-full flex flex-col justify-between w-full relative">
                ...
                <div className="flex flex-col w-full mt-3">
                  ...
                  <button
                    ...
                    className="max-h-12 lg:max-h-24 w-full font-bold bg-green-600 px-3 py-2 lg:py-4 mt-6 hover:bg-green-500 rounded-b-lg md:rounded-br-none sm:rounded-bl-lg"
                  >
