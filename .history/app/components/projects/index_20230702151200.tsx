...
export default function ProjectsPage({ dictionary }: { dictionary: any }) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`w-full h-max lg:min-h-screen bg-gradient-to-t from-gray-600 via-gray-400 to-gray-600 bg-opacity-75 flex items-center relative overflow-hidden`}
      >
        <Animate>
          <div className="w-full mx-auto px-3 lg:px-0 lg:w-3/4 h-full relative overflow-hidden">
            ...
            <div className="flex flex-col w-full sm:w-4/5 mx-auto">
              <div className="flex flex-col h-max py-12 lg:h-screen justify-center relative select-none">
                <div className="h-max flex flex-col justify-center rounded-md bg-opacity-75">
