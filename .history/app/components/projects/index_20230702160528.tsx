          ...
          {dictionary.ProjectsThumbnails.map((thumbnail: any, idx: number) => (
            ...
            >
              ...
              <div className="flex flex-col mt-16">
                <div className="text-2xl w-max mx-auto lg:mx-0">
                  {dictionary.ProjectsPage.stack}
                </div>
                <div className="flex flex-row flex-wrap justify-evenly w-full gap-3">
                  {thumbnail.stack.map((stackItem: any, idx: number) => (
                    <div
                      className="py-1 px-3 sm:p-2 text-xl lg:p-3 bg-slate-800 mt-3  sm:gap-3"
                      key={idx}
                    >
                      {stackItem}
                    </div>
