...
export default function ProjectsPage({ dictionary }: { dictionary: any }) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`w-full min-h-screen bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 ${
      ...
      <div className="w-full min-h-screen flex flex-col bg-gradient-to-t from-gray-600 via-gray-400 to-gray-600 background-position text-white pb-24">
