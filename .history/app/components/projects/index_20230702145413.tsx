...
export default function ProjectsPage({ dictionary }: { dictionary: any }) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`w-full min-h-screen bg-gradient-to-t from-gray-600 via-gray-400 to-gray-600 ${
          isVisible && "gradient-animation"
        } delay-500 flex items-center relative overflow-hidden`}
      >
        <Animate>
              ...
              <div className="flex flex-col h-screen justify-center relative select-none">
                <div className="h-max flex flex-col justify-center rounded-md">
                  ...
                  <div className="relative flex flex-col text-lg text-center lg:text-left sm:text-2xl w-full italic font-extralight pt-6 text-gray-200 drop-shadow-lg shadow-black">
                    ...
                    <ScrollButton to="1">
                      <span
                        className="text-xl italic font-extralight ml-auto mr-auto lg:ml-32 h-max lg:text-2xl text-white flex flex-row items-center p-3 hover:to-gray-400 rounded-md bg-green-500 hover:bg-green-400
                      w-max mt-6 lg:mx-0"
                      >
