...
export default function ProjectsPage({ dictionary }: { dictionary: any }) {
  ...
  return (
    <>
      ...
      >
        <Animate>
          <section className="w-full mx-auto px-3 lg:px-0 lg:w-3/4 h-full relative overflow-hidden bg-black">
            <div
            ...
            <div className="flex flex-col w-full sm:w-4/5 mx-auto">
              <div className="flex flex-col h-max py-12 lg:h-screen justify-center relative select-none">
                <div className="h-max flex flex-col justify-center rounded-md">
                  ...
                  <h1 className="text-6xl sm:text-7xl lg:text-8xl text-white mx-auto lg:mx-0 w-max sm:mt-0">
                  ...
                  <div className="relative flex flex-col text-lg text-center lg:text-left sm:text-2xl w-full italic font-extralight pt-6 text-gray-200 drop-shadow-lg shadow-black">
                    <span className="pl-0 lg:pl-32 w-3/4 lg:w-full mx-auto ">
