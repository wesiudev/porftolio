...
export default function FurtherHeader({
  ...
  return (
    <>
      <div className="fixed left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] h-max">
        {isMenuOpen && (
          <div className="flex flex-col bg-white text-black px-6 py-6 relative rounded-lg text-xl w-full">
            <div className="bg-white h-7 w-7 rotate-45 absolute left-[50%] -translate-x-[50%]" />
