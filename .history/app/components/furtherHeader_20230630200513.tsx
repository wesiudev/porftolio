          ...
          <div className="group relative w-max mx-auto">
            ...
            <div className="translate-y-[-50vh] opacity-0  group-hover:opacity-100 group-hover:translate-y-0 hover:translate-y-12  ease-in-out absolute left-[50%] -translate-x-[50%] p-6 w-max pt-12 z-[5]">
              <div className="flex flex-col bg-white text-black px-6 py-6 relative rounded-lg">
                ...
                <Link
                  className="hover:bg-gray-200 duration-200 w-full px-8 flex flex-row items-center relative py-2"
                  href="https://www.wesiu.dev"
                >
                  <ImBookmark className="absolute top-[50%] -translate-y-[50%] left-1 text-yellow-400" />
                  Portfolio
                </Link>
                <Link
                  className="hover:bg-gray-200 duration-200 w-full px-8 flex flex-row items-center relative py-2"
