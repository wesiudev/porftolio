    ...
    <>
      ...
      <div
        className={`${
          ...
          isBottomVisible
            ? "rounded-b-0"
            : "sm:rounded-b-[125px] lg:rounded-b-[250px]"
        } duration-500 w-full bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-hidden `}
      >
        <div
