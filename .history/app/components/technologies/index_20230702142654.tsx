      ...
      <div
        className={`${
          isVisible
            ...
            : "sm:rounded-t-[250px] lg:rounded-t-[500px]"
        } sm:rounded-b-[125px] lg:rounded-b-[250px] duration-500 w-full bg-gradient-to-b from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-hidden pb-24`}
      >
        <div
