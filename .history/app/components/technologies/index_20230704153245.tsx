      ...
      <div
        ...
        ${
          isBottomVisible
            ...
            : "rounded-b-0"
        } duration-500 w-full lg:w-3/4 bg-gradient-to-l from-gray-600 via-gray-400 to-gray-600 min-h-screen flex flex-col relative overflow-hidden sm:pb-12 lg:pb-24`}
      >
        <div
