    ...
    >
      <div className="w-[90vw] lg:w-3/4 h-full mx-auto flex flex-row items-center justify-between">
        <div className="text-white w-full h-full flex items-center rounded-md bg-slate-600">
          <div className="group relative w-max sm:mx-auto">
        ...
        <div className="w-full group hidden sm:block">
          <div className="w-max relative bg-slate-700  px-3 py-2 rounded-md">
            <div className="w-max text-white flex flex-row items-center justify-center cursor-default font-bold text-xl">
              <div className="px-2 py-1 rounded-sm bg-red-600 flex items-center justify-center mr-2">
